...
rs-module .material-icons {
  ...
  -moz-osx-font-smoothing: grayscale;
	...
	public function add_inline_double_jquery_error($do_check = false){
		if(Framework::$rs_double_jquery_script === false || $do_check === true){
			...
			echo RS_T4.'err += "Some problems with loading slider libraries.<br>";'."\n";
		...
		Framework::$rs_double_jquery_script = ($do_check === false) ? true : Framework::$rs_double_jquery_script;
	}
