...
], function ($, confirmation, ko, Component, quote, fee, applyFeesAction, messageContainer, $t, urlBuilder, utils, Registry, defaultTotal, cartCache, shippingFee) {
    'use strict';
        ...
        updateContent: function (code) {
            ...
            if (fieldset) {
                content.done(function (components) {
                    ...
                    shippingFee.hasShippingInsurance(wholeFormVisibility);
