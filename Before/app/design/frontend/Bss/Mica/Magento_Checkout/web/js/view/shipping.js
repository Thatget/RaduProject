    ...
    return Component.extend({
        ...
        setShippingInformation: function () {
            if (this.validateShippingInformation()) {
                ...
                var self = this,
                    formData = this.source.get('mageworxShippingFeeForm');
                if (shippingFee.hasShippingInsurance() && !shippingFee.hasValue()) {
                        ...
                        if (index != 'type') {
                            if (_.isEmpty(optionVal)) {
                                confirmation({
                                    ...
                                    actions: {
                                        confirm: function () {
                                            self.updateShippingInsurance(formData, index);
                                            return false;
                                        },
                                        cancel: function () {
        ...
        updateShippingInsurance: function (formData, index) {
